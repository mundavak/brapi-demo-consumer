...
import com.bookmap.demo.consumer.providers.value.LiquidityMarkersValueHandler;
...
public enum Provider {
        ...
        SWEEPS_INDICATOR("Sweeps indicator", "velox.indicators.absorption.SweepsIndicator",
                        AbsorptionAndSweepsValueHandler.class, DefaultInstrumentsController.class),
        LIQUIDITY_MARKERS("Liquidity Markers", "velox.api.layer1.addons.liquidity.LiquidityMarkersOverlay",
                        LiquidityMarkersValueHandler.class, DefaultInstrumentsController.class),
