...
public class SimpleDemoProvider implements
    ...
    private final ExecutorService messageSender = ExecutorsHelper
            .newSingleThreadExecutor("Simple-Demo-provider-message-sender");
    ...
    public void onUserMessage(Object data) {
        ...
        if (data instanceof CustomGeneratedEventAliased eventAliased) {
            // Receive the event generated by our generator and send it to the panel and
            // BrAPI.
    ...
    private Layer1ApiUserMessageAddStrategyUpdateGenerator getGeneratorMessage(boolean isAdd, String alias,
            Generator generator) {
